...
\subsection{Fusing similar network has the same effect as increasing the number of experimental conditions}
When the sample size of gene expression increases, the performance
